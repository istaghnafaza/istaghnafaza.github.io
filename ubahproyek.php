...
<body>
    ...
    <!-- //enctype untuk jalur gambar, method post untuk jalur text -->
            ...
            <table>
            <tr>
                        <input type="hidden" name="id_proyek" id="id_proyek" value="<?= $proyek["id_proyek"]?>">
                        <input type="hidden" name="gambarLama" id="gambarLama" value="<?= $proyek["gambar"]?>">
                        <td><strong><label for="">Nama Client</label></strong></td>
                        <td><input type="text" name="nama_client" value="<?= $proyek["nama_client"]?>"></td>
                    </tr>
                    <tr>
                        <td><strong><label for="">Nama Proyek</label></strong></td>
                        <td><input type="text" name="nama_proyek" value="<?= $proyek["nama_proyek"]?>"></td>
                    </tr>
                    <tr>
                        <td><strong><label for="lokasi">Lokasi Proyek</label></strong></td>
                    <td><input type="text" name="lokasi" id="lokasi" value="<?= $proyek["lokasi"]?>"></td> </tr>
                    <tr>
                        <td><strong><label for="tgl">Tanggal Mulai</label></strong></td>
                        <td><input type="date" name="tgl_mulai" value="<?= $proyek["tgl_mulai"]?>"></td>
                    </tr>
                    <tr>
                        <td><strong><label for="tgl">Tanggal Selesai</label></strong></td>
                        <td><input type="date" name="tgl_selesai" value="<?= $proyek["tgl_selesai"]?>"></td>
                    </tr>
                    <tr>
                        <td><strong><label for="tgl">Status</label></strong></td>
                        <td>
                        <select name="status" id="status" value="<?= $proyek["status"]?>">
                    ...
                    <tr>
                        ...
                        <img src="img/<?= $proyek["gambar"]?>" alt=""  width="100px" height="100px" >
